...
class SocioEconomicoFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'candidato_trabaja'   => $this->faker->randomElement($array = array ('Si','No')),
            'candidato_lugar_trabajo' => $this->faker->company,
            'candidato_funcion_trabajo' => $this->faker->jobTitle,
            'candidato_rango_salarial'  => $this->faker->randomElement($array = array ('RD$1-10000','RD$10000-20000','RD$20000- 30000','RD$30000-40000','Más de RD$50000')),
