...
class InstitutionOfferResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'academic_offer_pensum_url' => $this->academic_offer->pensum_url,
            'academic_offer_pensum_ext' => $this->academic_offer->pensum_ext,
            'academic_offer_pensum_size' => $this->academic_offer->pensum_size,
